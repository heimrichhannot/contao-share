...
$arrLang['printWithoutTemplate'][0] = 'Print article without print template';
$arrLang['printWithoutTemplate'][1] = 'Prints the article direct from browser without using the print template.';

$arrLang['share_addTemplateLinks'][0] = 'Add share urls to template';
$arrLang['share_addTemplateLinks'][1] = 'Add an additional template variable containing share urls.';

/**
 * Legends
 */
$arrLang['share_legend'] = 'Share settings';
